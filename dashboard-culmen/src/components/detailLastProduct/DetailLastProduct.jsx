      ...
      {lastProductDetail.product && (
        <>
          <div>
            ...
            <Font2>
              Nombre:{" "}
              <Font1>{lastProductDetail.product.name.toUpperCase()}</Font1>{" "}
            </Font2>
            <Font2>
              Descripcion{" "}
              <Font1>
                {lastProductDetail.product.description.toUpperCase()}
              </Font1>{" "}
            </Font2>
            <Font2>
              Marca:{" "}
              <Font1>{lastProductDetail.product.brand.toUpperCase()}</Font1>{" "}
            </Font2>
            <Font2>
              Categoria:
              <Font1> {lastProductDetail.product.category.toUpperCase()}</Font1>{" "}
            </Font2>
            <Font2>
              Tipo:{" "}
              <Font1>{lastProductDetail.product.type.toUpperCase()}</Font1>{" "}
            </Font2>
            <Font2>
              Precio: <Font1>{lastProductDetail.product.price}</Font1>{" "}
            </Font2>
          </div>
          <ContainerImg>
            <img
            ...
            />
            <a
              href={`https://culmen-shop-production.up.railway.app/products/${lastProductDetail.product.id}`}
            >
              {" "}
